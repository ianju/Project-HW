...
public class ElevatorMiner : BaseMiner
{
    ...
    public Vector3 DepsitLocation => new Vector3(transform.position.x, elevator.DepositLocation.position.y);
    ...
    private void MoveToNextLocation()
    {
        ...
        Vector3 shaftDepositPos = currentShaft._DepositLocation.position;
